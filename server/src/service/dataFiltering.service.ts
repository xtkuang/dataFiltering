    ...
    async getData(params:any){
        const data=await prisma.project.findMany({
            ...
            where:{
                ...
                category:params.projectCategory ? {contains:params.projectCategory} : undefined, //项目分类
                equipment:{
                    some:{
                        code:params.equipmentCode ? {contains:params.equipmentCode} : undefined, //设备编号
                        name:params.equipmentName ? {contains:params.equipmentName} : undefined, //设备名称
                        type:params.equipmentType ? {contains:params.equipmentType} : undefined, //设备类型

                        workstation:{
                            some:{
                                code:params.workStationCode ? {contains:params.workStationCode} : undefined, //工位编号
                                name:params.workStationName ? {contains:params.workStationName} : undefined, //工位名称
                                type:params.workStationType ? {contains:params.workStationType} : undefined, //工位类型
                                ...
                                materials:{
                                    some:{
                                        code:params.materialCode ? {contains:params.materialCode} : undefined, //物料编号
                                        name:params.materialName ? {contains:params.materialName} : undefined,
                                        modelNumber:params.materialModelNumber ? {contains:params.materialModelNumber} : undefined, //物料型号
                                        category:params.materialCategory ? {contains:params.materialCategory} : undefined, //物料分类
